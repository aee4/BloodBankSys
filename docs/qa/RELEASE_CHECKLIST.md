...
| 7 | **Stock Integrity & Immutability:** Inventory never becomes negative (`Total >= Reserved >= 0`), and all changes produce immutable transaction records. | `InventoryAcceptanceTests.cs` | `[VERIFIED PASS]` |
