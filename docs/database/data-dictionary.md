...
| `InventoryTransactions` | Immutable stock-change ledger and resulting balances | Inventory and actor FKs `NO ACTION`; a non-zero change; resulting balances valid |
